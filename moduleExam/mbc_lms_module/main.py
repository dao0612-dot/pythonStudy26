...
from MemberService import * #회원관리용 클래스
from ScoreService import * #학생점수관리용 클래스
from BoardService import * #게시판관리용 클래스
from ItemService import * #상품관리용 클래스
...
def main():
    ...
    while run:
        ...
        if select == "1":
            ...
            #교수 전용 서비스 클래스 호출용 코드

            print("교수 전용 서비스를 종료합니디.")
